<div class="main-sidebar">
    <aside id="sidebar-wrapper bg-primary">
      <div class="sidebar-brand mt-5">
        <a href="{{ route('admin.home') }}"><h1>TNL</h1></a>
      </div>
      <ul class="sidebar-menu mt-5">
      <li><a class="nav-link" href="{{ route('admin.home') }}"><i class="fa fa-chart-bar"></i> <span>Tableau de Bord</span></a></li>
      <li><a class="nav-link" href="{{ route('event.index') }}"><i class="far fa-calendar-alt"></i> <span>Mes évènements</span></a></li>
      <li><a class="nav-link" href="{{ route('event.create') }}"><i class="far fa-plus-square"></i> <span>Ajouter un évènement</span></a></li>
